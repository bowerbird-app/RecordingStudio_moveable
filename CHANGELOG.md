...
### Added
- Tracked `.cursor/` boot files: `environment.json`, `install.sh`, `fetch-skills.sh`, and `start.sh`.
- `test/cursor_install_test.rb` plus a dummy boot-files test that environment terminals point at `test/dummy`.
