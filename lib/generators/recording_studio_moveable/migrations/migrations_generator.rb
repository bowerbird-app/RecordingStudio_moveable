...
module RecordingStudioMoveable
  module Generators
    # Generator to install RecordingStudioMoveable migrations into the host application.
    #
    # Usage:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioMoveable migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioMoveable.", :yellow
          return
        end
