  ...
  module Services
    ...
    class BaseService
      ...
      def run_before_hooks
        ...
        RecordingStudioMoveable::Hooks.run(:before_service, self.class, service_args)
      end
      ...
      def run_after_hooks(result)
        ...
        RecordingStudioMoveable::Hooks.run(:after_service, self.class, result)
      end
      ...
      def run_with_around_hooks
        if hooks_enabled? && RecordingStudioMoveable.configuration.hooks.registered?(:around_service)
          RecordingStudioMoveable::Hooks.run_around(:around_service, self) { perform }
        else
          perform
        end
      end
      ...
      # @return [Boolean]
      def hooks_enabled?
        defined?(RecordingStudioMoveable) &&
          RecordingStudioMoveable.respond_to?(:configuration) &&
          RecordingStudioMoveable.configuration.respond_to?(:hooks)
      end
