...
This document outlines the security considerations for the recording_studio_moveable Rails engine.
...
**Locations**:
- `app/controllers/recording_studio_moveable/moveables_controller.rb`
