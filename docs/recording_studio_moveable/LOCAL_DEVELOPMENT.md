...
```bash
git clone https://github.com/bowerbird-app/RecordingStudio_moveable.git
cd recording_studio_moveable
```
...
Open http://localhost:3000/recording_studio_moveable
...
├── lib/
│   ├── recording_studio_moveable.rb       # Main entry point
│   ├── recording_studio_moveable/
